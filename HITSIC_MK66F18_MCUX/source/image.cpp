...
void image_main()
{
        int white_front=0,white_back=0;
        //int crossroad_flag=0;//十字标志
        if(image_times<2)//为mid_last_line赋初值
        {
            image_times++;
            get_mid_line();
            for (int i = 0; i <= 119; i++)
...
//    banmaxian();
    ...
    //{
    //    find_rightup_point(10, 100);
    //    find_leftup_point(10, 100);
